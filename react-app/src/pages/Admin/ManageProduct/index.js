										...
										<>
											<tr>
												...
												<td>
													...
													<EyeOutlined style={{ fontSize: '18px', color: '#08c', marginRight: '10px' }} onClick={() => history.push(`/admin/productDetailsAdmin/${item.id}`)} />

													<EditOutlined style={{ fontSize: '18px', color: '#52c41a', marginRight: '10px' }} onClick={() => getInfo(item.id)} />
