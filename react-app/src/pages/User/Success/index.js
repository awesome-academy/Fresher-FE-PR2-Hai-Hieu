...
const Success = ({ match, getBill, billData }) => {
    ...
    const handleCalculateToTal = () => {
        const shippingCost = billData.shippingCost;
        let total = 0;
        billData?.dataCart?.forEach((element) => {
            total = total + parseFloat((element.newPrice * element.quantity) + shippingCost);
        });
                        ...
                        <div className=' success__container'>
                            ...
                            <div className='success__info'>
                                ...
                                <div className='success__info--item'>
                                    ...
                                    <p>
                                        {
                                            billData?.shippingCost?.toLocaleString()
                                        }
                                    </p>
                                </div>
                                <div className='success__info--item'>
                                    <h4>{t('success.Total amount')}: </h4>
                                    <p className='text-danger'>{handleCalculateToTal().toLocaleString()}</p>
                                </div>
                            </div>
